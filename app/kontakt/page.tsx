...
import { Phone, Mail, MapPin, Clock, MessageSquare, Send, CheckCircle, Users, Calendar, FileText } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Profesjonalne doradztwo w sprawach cywilnych, gospodarczych i administracyjnych",
      price: "Od 150 zł/h",
    },
    {
      title: "Analiza Dokumentów",
      description: "Szczegółowa analiza nakazów zapłaty, wezwań komorniczych i innych pism",
      price: "Od 49 zł",
    },
    {
      title: "Pisma Procesowe",
      description: "Przygotowanie sprzeciwów, skarg, wniosków i innych dokumentów prawnych",
      price: "Od 89 zł",
    },
    {
      title: "Reprezentacja Sądowa",
      description: "Pełna reprezentacja w postępowaniach sądowych i administracyjnych",
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">SKONTAKTUJ SIĘ Z NAMI</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Profesjonalna Pomoc Prawna w Gdańsku</h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Doświadczeni prawnicy, nowoczesne rozwiązania technologiczne i indywidualne podejście do każdego klienta.
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-gray-600">
                    Wypełnij formularz, a skontaktujemy się z Tobą w ciągu 2 godzin roboczych
                  </p>
                </CardHeader>
                <CardContent>
                ...
                <Card className="border-red-200 bg-red-50">
                  ...
                  <CardContent>
                    <p className="text-red-700 mb-3">
                      W sprawach pilnych (nakazy zapłaty, egzekucja komornicza) dzwoń:
                    </p>
                    <a href="tel:+48581234567" className="text-xl font-bold text-red-800 hover:text-red-900 block mb-2">
                      +48 58 123 45 67
                    </a>
                    <p className="text-sm text-red-600">Dostępne 24/7 dla spraw pilnych</p>
                  </CardContent>
                </Card>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Znajdziesz nas w sercu Starego Miasta w Gdańsku, blisko Ratusza Głównego Miasta
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-6">Kancelaria LegalNexus</h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <MapPin className="h-5 w-5 text-blue-600 mr-3 mt-1" />
                    <div>
                      <p className="font-semibold">ul. Długa 46/47, 80-831 Gdańsk</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Płatny parking miejski w pobliżu</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Wyłącznie po wcześniejszym umówieniu</p>
                    </div>
                  </div>
                </div>
                <Button className="mt-6" asChild>
                  <a href="https://maps.google.com/?q=Długa+46+Gdańsk" target="_blank" rel="noopener noreferrer">
