...
export default function KonsultacjePage() {
  const consultationTypes = [
    {
      ...
      description: "Szybka konsultacja prawna przez telefon w dogodnym dla Ciebie terminie",
      icon: Phone,
      price: "150 zł/h",
      duration: "30-60 min",
      popular: true,
    ...
    },
    {
      ...
      description: "Profesjonalna konsultacja prawna przez wideokonferencję z możliwością udostępniania dokumentów",
      icon: Video,
      price: "180 zł/h",
      duration: "30-90 min",
      popular: false,
    ...
    },
    {
      ...
      description: "Szczegółowa odpowiedź prawna w formie pisemnej na Twoje pytania",
      icon: MessageSquare,
      price: "120 zł",
      duration: "24-48h",
      popular: false,
    ...
    },
    {
      ...
      description: "Pilna konsultacja prawna w sprawach wymagających natychmiastowej reakcji",
      icon: Clock,
      price: "200 zł/h",
      duration: "15-30 min",
      popular: true,
  ...
  const specializations = [
    ...
    },
    {
      ...
      areas: ["Działalność gospodarcza", "Umowy handlowe", "Spory z kontrahentami", "Windykacja"],
    },
    {
      title: "Prawo Pracy",
    ...
    },
    {
      ...
      areas: ["Decyzje administracyjne", "Odwołania", "Postępowania", "Koncesje i zezwolenia"],
    },
  ]
  ...
  const process = [
    {
      ...
      description: "Zdecyduj czy potrzebujesz konsultacji telefonicznej, online czy pisemnej",
    },
    {
      step: "2",
  ...
  const benefits = [
    {
      ...
      description: "Konsultacje prowadzone przez prawników z wieloletnim doświadczeniem",
    },
    {
      icon: Clock,
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-montserrat">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">PROFESJONALNE KONSULTACJE PRAWNE</Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Konsultacje Prawne Online</h1>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Potrzebujesz szybkiej porady prawnej? Skorzystaj z naszych profesjonalnych konsultacji online,
                telefonicznych lub pisemnych. Doświadczeni prawnicy pomogą Ci rozwiązać każdy problem prawny.
              </p>
        ...
        <section id="rodzaje-konsultacji" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Rodzaje Konsultacji Prawnych</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Wybierz formę konsultacji, która najlepiej odpowiada Twoim potrzebom. Wszystkie konsultacje prowadzone
                przez doświadczonych prawników.
              </p>
            </div>
              ...
              {consultationTypes.map((consultation, index) => (
                ...
                >
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          <CardTitle className="text-xl font-bold">{consultation.title}</CardTitle>
                          <p className="text-sm text-gray-500">{consultation.duration}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-blue-600">{consultation.price}</div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    ...
                    <Button className="w-full font-medium" variant={consultation.popular ? "default" : "outline"}>
                      Zarezerwuj Konsultację
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Prosty proces w 4 krokach - od wyboru rodzaju konsultacji do otrzymania profesjonalnej pomocy prawnej
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Dlaczego Nasze Konsultacje?</h2>
            </div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Potrzebujesz Porady Prawnej?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Nie czekaj - skorzystaj z profesjonalnej konsultacji prawnej już dziś!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
