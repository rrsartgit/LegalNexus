      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">OCHRONA TWOICH DANYCH</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Polityka Prywatności LegalNexus</h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Dbamy o bezpieczeństwo Twoich danych osobowych. Zapoznaj się z naszą polityką prywatności, aby dowiedzieć
              się, jak gromadzimy, przetwarzamy i chronimy Twoje informacje.
            </p>
          </div>
        </section>
                  ...
                  <Card key={index} id={`section-${index + 1}`} className="shadow-md">
                    <CardHeader>
                      <CardTitle className="text-2xl flex items-center">
                        {index === 0 && <Info className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 1 && <User className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 2 && <Database className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 3 && <Lock className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 4 && <Mail className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 5 && <Clock className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 6 && <Shield className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 7 && <Cookie className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 8 && <Info className="mr-2 h-6 w-6 text-blue-600" />}
                        {section.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Masz Pytania Dotyczące Prywatności?</h2>
