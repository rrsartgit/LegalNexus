...
export default function ReprezentacjaPage() {
  ...
  const process = [
    ...
    },
    {
      ...
      description: "Szczegółowa analiza wszystkich dokumentów związanych ze sprawą",
    },
    {
      step: "3",
      title: "Strategia Procesowa",
      description: "Opracowanie strategii prowadzenia sprawy i harmonogramu działań",
    },
    {
      step: "4",
      title: "Reprezentacja Sądowa",
      description: "Pełna reprezentacja procesowa aż do prawomocnego zakończenia sprawy",
    },
  ]
  ...
  const advantages = [
    {
      ...
      description: "Prawnicy z wieloletnim doświadczeniem w reprezentacji sądowej",
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      description: "Ubezpieczenie OC prawnika i gwarancja profesjonalnej obsługi",
    },
    {
      icon: Clock,
      title: "Terminowość",
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-montserrat">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">PROFESJONALNA REPREZENTACJA PRAWNA</Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Reprezentacja Sądowa</h1>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Potrzebujesz profesjonalnej reprezentacji w sądzie? Nasz doświadczony zespół prawników zapewni Ci pełną
                obsługę prawną od analizy sprawy do prawomocnego wyroku.
              </p>
        ...
        <section id="rodzaje-reprezentacji" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Rodzaje Reprezentacji Prawnej</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Oferujemy pełną reprezentację prawną we wszystkich rodzajach postępowań sądowych i administracyjnych
              </p>
            </div>
                ...
                >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{type.pricing}</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-3 mb-6">
                      <h4 className="font-semibold text-gray-900">Obszary reprezentacji:</h4>
                    ...
                    <Button className="w-full font-medium" variant={type.popular ? "default" : "outline"} asChild>
                      <Link href="/kontakt">
                        Umów Konsultację
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Co Obejmuje Reprezentacja?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Pełna obsługa prawna od momentu przyjęcia sprawy do jej prawomocnego zakończenia
              </p>
            </div>
              ...
              {services.map((service, index) => (
                <Card
                  ...
                  className={`hover:shadow-lg transition-shadow ${
                    service.included ? "border-green-200 bg-green-50" : "border-gray-200"
                  }`}
                >
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      {service.included ? (
                        <Badge className="bg-green-100 text-green-800">Wliczone</Badge>
                      ) : (
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Jak Przebiega Reprezentacja?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Strukturalny proces reprezentacji prawnej zapewniający najwyższą jakość obsługi
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Dlaczego Warto Nas Wybrać?</h2>
            </div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Potrzebujesz Reprezentacji Prawnej?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Skontaktuj się z nami już dziś i umów bezpłatną konsultację. Ocenimy Twoją sprawę i przedstawimy plan
              działania.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold" asChild>
