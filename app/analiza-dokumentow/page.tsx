...
export default function AnalizaDokumentowPage() {
  const documentTypes = [
    {
      title: "Nakaz Zapłaty",
      description: "Analiza formalnej poprawności nakazu zapłaty i możliwości obrony",
      price: "49 zł",
      time: "24h",
      popular: true,
      features: [
  ...
  const process = [
    {
      ...
      description: "Wgraj skan lub zdjęcie dokumentu w formacie PDF, JPG lub PNG",
    },
    {
      step: "2",
      title: "Opisz Sytuację",
      description: "Wypełnij krótki formularz z podstawowymi informacjami o sprawie",
    },
    {
      step: "3",
      title: "Zapłać za Analizę",
      description: "Bezpieczna płatność kartą lub BLIK z automatyczną fakturą VAT",
    },
    {
      step: "4",
      title: "Otrzymaj Analizę",
      description: "Szczegółowy raport prawny przygotowany przez doświadczonych prawników",
    },
  ]
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Analizy przygotowywane przez prawników z wieloletnim doświadczeniem",
    },
    {
      icon: Shield,
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-montserrat">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">PROFESJONALNA ANALIZA PRAWNA</Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Analiza Dokumentów Prawnych</h1>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Otrzymałeś pismo prawne i nie wiesz jak się zachować? Nasze profesjonalne analizy pomogą Ci zrozumieć
                sytuację i podjąć właściwe działania.
              </p>
        ...
        <section id="rodzaje-analiz" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Rodzaje Analiz Dokumentów</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Oferujemy profesjonalne analizy wszystkich rodzajów dokumentów prawnych. Każda analiza zawiera
                szczegółowe omówienie i konkretne wskazówki działania.
              </p>
            </div>
                ...
                >
                  ...
                  <CardContent>
                    <div className="space-y-3 mb-6">
                      <h4 className="font-semibold text-gray-900">Co zawiera analiza:</h4>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Jak Przebiega Analiza?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Prosty proces w 4 krokach - od przesłania dokumentu do otrzymania profesjonalnej analizy prawnej
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Dlaczego Warto Wybrać Nasze Analizy?</h2>
            </div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Potrzebujesz Analizy Dokumentu?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Nie czekaj - każdy dzień zwłoki może mieć znaczenie prawne. Zamów profesjonalną analizę już dziś!
            </p>
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold" asChild>
              <Link href="/zamow-analize">
                <Upload className="mr-2 h-5 w-5" />
