...
export default function PanelKlientaPage() {
  ...
  const [activeSection, setActiveSection] = useState("panel-klienta") // Default active section for client
  ...
  const mockCases: Case[] = [
    {
      ...
      generatedDocuments: [],
      clientNotes: "Nie zgadzam się z wysokością odsetek. Mam dokumenty potwierdzające częściowe spłaty.",
    ...
    },
    {
      ...
      generatedDocuments: [],
      clientNotes: "Otrzymałem wezwanie do zapłaty od komornika. Czy mogę się odwołać?",
  ...
  return (
    <ClientLayout allowedRoles={["client"]}>
                    ...
                    <Card key={case_.id} className="hover:shadow-md transition-shadow">
                      <CardHeader>
                        <div className="flex justify-between items-start">
                          <div>
                            <CardTitle className="text-lg font-semibold">{case_.name}</CardTitle>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        {case_.clientNotes && (
                          <div className="bg-blue-50 p-3 rounded-lg">
                            <h5 className="text-sm font-medium text-blue-800 mb-1">Twoje notatki:</h5>
                            <p className="text-sm text-blue-700">{case_.clientNotes}</p>
                          </div>
                        )}
                          ...
                          <div className="border-t pt-4">
                            <div className="flex justify-between items-center mb-3">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm text-gray-500">{case_.analysis.price} zł</span>
                              </div>
                            </div>
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg mb-4">
                              ...
                              <div className="mb-3">
                                ...
                                <ul className="text-sm text-gray-600 space-y-1">
                                  {case_.analysis.recommendations.map((rec, idx) => (
                                    ...
                                    >
                                      <CardContent className="p-4">
                                        <div className="flex justify-between items-start mb-2">
                                          ...
                                          <span className="text-sm font-bold text-blue-600">{doc.price} zł</span>
                                        </div>
