    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Tak, za każdą opłaconą usługę automatycznie otrzymasz fakturę VAT na podany adres e-mail.",
        },
      ],
    },
    {
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">NAJCZĘŚCIEJ ZADAWANE PYTANIA</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">FAQ - Często Zadawane Pytania</h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Znajdź odpowiedzi na najczęściej zadawane pytania dotyczące naszych usług, płatności i bezpieczeństwa.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <div className="lg:col-span-3 space-y-12">
                {faqCategories.map((category, catIndex) => (
                  <div key={catIndex} id={`category-${catIndex}`} className="space-y-6">
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      {category.questions.map((item, qIndex) => (
                        <Card key={qIndex} className="mb-4 shadow-sm hover:shadow-md transition-shadow">
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Nie Znalazłeś Odpowiedzi?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Skontaktuj się z nami bezpośrednio, a chętnie odpowiemy na wszystkie Twoje pytania.
            </p>
