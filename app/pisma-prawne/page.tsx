  ...
  const documentCategories = [
    {
      ...
      documents: [
        ...
        },
        {
          ...
          description: "Szczegółowa odpowiedź na zarzuty zawarte w pozwie sądowym",
          price: "149 zł",
          time: "48h",
          popular: false,
        },
    ...
    },
    {
      ...
      documents: [
        ...
        },
        {
          ...
          description: "Projekt ugody pozasądowej z wierzycielem lub dłużnikiem",
          price: "79 zł",
          time: "18h",
          popular: true,
        },
        ...
        },
        {
          ...
          description: "Formalne pismo w sprawach bankowych lub ubezpieczeniowych",
          price: "69 zł",
          time: "12h",
          popular: false,
        },
  ...
  const process = [
    {
      step: "1",
      title: "Zamów Analizę",
      description: "Najpierw zamów analizę dokumentu, aby poznać możliwe działania prawne",
    },
    {
      step: "2",
      title: "Wybierz Pismo",
      description: "Na podstawie analizy wybierz odpowiednie pismo prawne z naszej oferty",
    },
    {
      step: "3",
      title: "Uzupełnij Dane",
      description: "Wypełnij formularz z danymi niezbędnymi do przygotowania pisma",
    },
    {
      step: "4",
      title: "Otrzymaj Dokument",
      description: "Gotowe pismo prawne przygotowane przez doświadczonych prawników",
    },
  ]
  ...
  const features = [
    {
      ...
      description: "Wszystkie pisma przygotowywane zgodnie z obowiązującymi przepisami",
    },
    {
      icon: Users,
      title: "Doświadczeni Prawnicy",
      description: "Dokumenty przygotowywane przez prawników z wieloletnim doświadczeniem",
    },
    {
      icon: Clock,
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-montserrat">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">PROFESJONALNE PISMA PRAWNE</Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Pisma Prawne Online</h1>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Potrzebujesz profesjonalnego pisma prawnego? Nasze doświadczone zespół prawników przygotuje dla Ciebie
                skuteczne dokumenty procesowe i pozasądowe.
              </p>
        ...
        <section id="rodzaje-pism" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Rodzaje Pism Prawnych</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Oferujemy pełen zakres pism prawnych - od sprzeciwów procesowych po propozycje ugód pozasądowych.
                Wszystkie dokumenty przygotowywane przez doświadczonych prawników.
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {category.documents.map((doc, docIndex) => (
                      ...
                      >
                        ...
                        <CardHeader>
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              <CardTitle className="text-lg font-bold mb-2">{doc.name}</CardTitle>
                              <p className="text-gray-600 text-sm">{doc.description}</p>
                            </div>
                            <div className="text-right ml-4">
                              <div className="text-xl font-bold text-blue-600">{doc.price}</div>
                        ...
                        <CardContent>
                          <Button className="w-full font-medium" variant={doc.popular ? "default" : "outline"} asChild>
                            <Link href="/zamow-analize">
                              Zamów Pismo
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Jak Zamówić Pismo Prawne?</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Prosty proces w 4 krokach - od analizy dokumentu do otrzymania gotowego pisma prawnego
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Dlaczego Nasze Pisma Prawne?</h2>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Opinie Naszych Klientów</h2>
            </div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Potrzebujesz Profesjonalnego Pisma Prawnego?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Nie ryzykuj samodzielnego przygotowywania dokumentów. Zamów profesjonalne pismo prawne już dziś!
            </p>
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold" asChild>
              <Link href="/zamow-analize">
