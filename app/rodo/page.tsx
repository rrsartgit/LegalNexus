...
import { Shield, User, Lock, Database, CheckCircle, Info, BookOpen, Mail } from "lucide-react"
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge className="bg-blue-800 text-blue-100 mb-4 font-medium">OCHRONA DANYCH OSOBOWYCH</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">RODO w LegalNexus</h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Zapewniamy pełną zgodność z Rozporządzeniem Ogólnym o Ochronie Danych Osobowych (RODO). Twoje dane są u
              nas bezpieczne.
            </p>
          </div>
        </section>
                  ...
                  <Card key={index} id={`section-${index + 1}`} className="shadow-md">
                    <CardHeader>
                      <CardTitle className="text-2xl flex items-center">
                        ...
                        {index === 2 && <Lock className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 3 && <Shield className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 4 && <Database className="mr-2 h-6 w-6 text-blue-600" />}
                        {index === 5 && <Info className="mr-2 h-6 w-6 text-blue-600" />}
                        {section.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Masz Pytania Dotyczące RODO?</h2>
