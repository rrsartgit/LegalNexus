...
import { Search, MapPin, Phone, Mail, Globe, Users, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  const searchLawFirms = async () => {
    try {
      ...
      const params = {
        ...
        ...(filters.specialization && { specializations: [filters.specialization] }),
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Znajdź Kancelarię Prawną</h1>
            ...
            <CardContent className="p-6">
              ...
              <div className="flex justify-between items-center mt-6">
                <p className="text-sm text-gray-600">
                  Znaleziono {pagination.total} {pagination.total === 1 ? "kancelarię" : "kancelarii"}
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {!searching && lawFirms.length === 0 && (
            <div className="text-center py-12">
              <p className="text-xl text-gray-600 mb-4">Nie znaleziono kancelarii spełniających kryteria</p>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      {firm.specializations.length > 0 && (
                        <div>
                          <p className="text-sm font-medium text-gray-700 mb-2">Specjalizacje:</p>
                      ...
                      {firm.lawyers.length > 0 && (
                        <div>
                          <div className="flex items-center space-x-1 mb-2">
                            ...
                            <p className="text-sm font-medium text-gray-700">Prawnicy ({firm.lawyers.length})</p>
                          </div>
                          <div className="space-y-1">
                            {firm.lawyers.slice(0, 2).map((lawyer) => (
                              <p key={lawyer.id} className="text-sm text-gray-600">
                                {lawyer.title} {lawyer.first_name} {lawyer.last_name}
                              </p>
                            ))}
                            {firm.lawyers.length > 2 && (
                              <p className="text-sm text-gray-500">i {firm.lawyers.length - 2} więcej...</p>
                            )}
                          </div>
                        </div>
                      )}
