...
export default function RejestracjaPage() {
  ...
  // Social registration will be implemented later with Supabase OAuth
  const handleSocialRegister = (provider: string) => {
    toast({
      title: "Funkcja w budowie",
      description: `Rejestracja przez ${provider} zostanie wkrótce dodana.`,
    })
  }

  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Header onSectionChange={() => {}} activeSection="rejestracja" /> {/* Pass dummy props for Header */}
        ...
        <div className="max-w-md mx-auto px-4">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <p className="text-gray-600">Utwórz nowe konto, aby uzyskać dostęp do platformy</p>
            </CardHeader>
