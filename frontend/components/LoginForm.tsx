  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: `Witaj z powrotem, ${user.email}!`,
      })
      // Redirect based on role
      if (user.role === "admin") {
        router.push("/dashboard") // Assuming /dashboard is the admin panel
      } else if (user.role === "operator") {
        router.push("/dashboard") // Assuming /dashboard is the operator panel
      } else {
        router.push("/dashboard") // Assuming /dashboard is the client panel
      }
    }
    setIsLoading(false)
  }
