    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input placeholder="Szukaj artykułów..." className="pl-10 dark:bg-gray-700 dark:text-white" />
                </div>
              </div>
        ...
        <section className="py-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8">Artykuł Polecany</h2>

          <Card className="overflow-hidden mb-16 dark:bg-gray-800">
        ...
        <section className="py-12 bg-white dark:bg-gray-800 rounded-lg mb-8">
          <div className="px-8">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Najnowsze Artykuły</h2>
              ...
              {blogPosts.map((post, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow dark:bg-gray-700">
                  <CardHeader>
                    ...
                    <CardTitle className="text-lg leading-tight line-clamp-2 dark:text-white">{post.title}</CardTitle>
                  </CardHeader>
